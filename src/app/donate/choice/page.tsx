...
export default function DonationChoicePage() {
  ...
  const handleLoginToDonate = () => {
    setIsRedirecting(true);
    // Redirect to login page with return URL to donation page
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <button
              ...
              className="w-full bg-gray-800 text-white py-3 px-4 rounded-lg font-medium hover:bg-gray-900 transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isRedirecting ? (
                <>
